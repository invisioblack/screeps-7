...
global.motivationDefense = require("motivationDefense");
profiler.registerClass(motivationDefense , 'motivationDefense');
...
global.needDropoff = require("needDropoff");
profiler.registerClass(needDropoff , 'needDropoff');
...
profiler.registerClass(needRHaul , 'needRHaul');
...
global.needRGarrison = require("needRGarrison");
profiler.registerClass(needRGarrison , 'needRGarrison');
global.needRHarvest = require("needRHarvest");
profiler.registerClass(needRHarvest , 'needRHarvest');
...
global.jobDropoff = require("jobDropoff");
profiler.registerClass(jobDropoff , 'jobDropoff');
